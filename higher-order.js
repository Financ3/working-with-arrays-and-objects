...
//Code Here
let evenNumbers = mixedNumbers.filter(element => element%2===0?true:false);
...
//Code Here
let totalPopulation  = populations.reduce((reducer, value) => reducer+=value)
...
let bobsTotal = purchases.filter(element => element.owner==="Bob").reduce(((sum, value)=>sum+=value.price), 0);